...
export const generalFaq: FaqItem[] = [
  {
    ...
    answer:
      'Vi har base i Jerlev tæt på Vejle og arbejder i hele Vejle-området samt Jelling, Give, Børkop, Egtved, Fredericia, Kolding og Hedensted og omegn. Er du i tvivl om, vi kommer til dig, så ring endelig.',
  },
  {
